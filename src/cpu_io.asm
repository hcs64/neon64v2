...
+
  j io_write_done
  ls_gp(sh a0, joy_shift + 1*2)

calculate_joy:
constant joystick_threshold(32)
  subi t3, a1, joystick_threshold
  bltz t3,+
  addi t3, a1, joystick_threshold
  ori a0, 0b0001
+
  bgtz t3,+
  subi t3, a2, joystick_threshold
  ori a0, 0b0010
+
  bltz t3,+
  addi t3, a2, joystick_threshold
  ori a0, 0b1000
+
  bgtz t3,+
  nop
